    ...
    <div class="slide-wrapper">
      ...
      >
        <swiper-slide style="width: auto">
          <div class="slide-box">
            <img
              src="../../assets/green-remodeling-construction-1.jpg"
              alt=""
            />
          </div>
        </swiper-slide>
        <swiper-slide style="width: auto">
          <div class="slide-box">
            <img
              src="../../assets/green-remodeling-construction-2.jpg"
              alt=""
            />
          </div>
        </swiper-slide>
        <swiper-slide style="width: auto">
          <div class="slide-box">
            <img
              src="../../assets/green-remodeling-construction-3.jpg"
              alt=""
            />
          </div>
        </swiper-slide>
        <swiper-slide style="width: auto">
          <div class="slide-box">
            <img
              src="../../assets/green-remodeling-construction-4.jpg"
              alt=""
            />
          </div>
        </swiper-slide>
        <swiper-slide style="width: auto">
          <div class="slide-box">
            <img
              src="../../assets/green-remodeling-construction-5.jpg"
              alt=""
            />
          </div>
        </swiper-slide>
  ...
  computed: {
    slidesPerView: function () {
      if (this.$vuetify.breakpoint.width < 1264) {
        return 1;
      } else if (this.$vuetify.breakpoint.width < 1625) {
        return 2;
      } else {
        return 3;
      }
