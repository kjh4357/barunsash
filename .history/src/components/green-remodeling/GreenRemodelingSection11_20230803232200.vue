<template>
  <section>
    ...
    >
      <form action="https://apis.aligo.in/send">
        <input hidden name="key" value="ho1yae29ulb4dose9fubrjdcife2crxv" />
        <input hidden name="user_id" value="barunsash" />
        <input hidden name="sender" value="01093314357" />
        <input hidden name="receiver" value="01093314357" />
        <input hidden name="testmode_yn" value="Y" />
        <div>
          <p>이름</p>
          <input v-model="inquiry.name" placeholder="" name="name" />
        </div>
        <div>
          <p>핸드폰 번호</p>
